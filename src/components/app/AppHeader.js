...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            ...
            const response = await fetch('https://raw.githubusercontent.com/sohzm/betterly/refs/heads/master/package.json');
    ...
    async _openUpdatePage() {
        ...
        await ipcRenderer.invoke('open-external', 'https://betterly.com');
    }
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Betterly',
            main: 'Betterly',
            customize: 'Customize',
            help: 'Help & Shortcuts',
        ...
        return titles[this.currentView] || 'Betterly';
    }
