...
This repository is Betterly, forked from [`cheating-daddy`](https://github.com/sohzm/cheating-daddy).
...
Pull requests from <https://github.com/sohzm/betterly> are commonly
